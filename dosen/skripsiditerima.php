...
<table>
	...
	$tampil2 = mysqli_query($kon, "select * from skripsi,mahasiswa,jurusan where skripsi.nobp = mahasiswa.nobp and mahasiswa.kdjurusan = jurusan.kdjurusan $jurusan and skripsi.status = 'acc'") or die(error);
